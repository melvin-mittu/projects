...
<form action="doctoraction.php" method="post" enctype="multipart/form-data"  onSubmit="return check();">
<table align="center">
<tr><th>NAME:&nbsp;&nbsp;&nbsp;</th>
...
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>ADDRESS:&nbsp;&nbsp;&nbsp;</th>
<td><textarea name="t3" rows="10" cols="30" required="yes" class="btn btn-primary"></textarea></td></tr>
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>PHONE NO:&nbsp;&nbsp;&nbsp;</th>
<td><input type="text" name="t4" id="t3" maxlength="10" minlength="10" required="yes" class="btn btn-primary"></td></tr>
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>EMAIL:&nbsp;&nbsp;&nbsp;</th>
<td><input type="email" name="t5" class="btn btn-primary"></td></tr>
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>GENDER:&nbsp;&nbsp;&nbsp;</th>
<td><input type="radio" name="t6" value="male" required="yes" class="btn btn-primary">MALE
<input type="radio" name="t6" value="female" required="yes" class="btn btn-primary">FEMALE</td></tr>
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>QUALIFICATION:&nbsp;&nbsp;&nbsp;</th>
<td><select name="t7" required="yes">
<option>MBBS</option>
<option>MD</option>
<option>PG</option>
<option>PHD</option>
...
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>DAY:&nbsp;&nbsp;&nbsp;</th>
<td><input type="text" name="t12" required="yes" class="btn btn-primary"></td></tr>
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>TIME:&nbsp;&nbsp;&nbsp;</th>
<td><input type="time" name="t9" required="yes" class="btn btn-primary"></td></tr>

<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>IMAGE:&nbsp;&nbsp;&nbsp;</th>
<td><input type="file" name="file" required="yes" class="btn btn-primary"></td></tr>
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>PASSWORD:&nbsp;&nbsp;&nbsp;</th>
<td><input type="password" name="t10" required="yes" class="btn btn-primary"></td></tr>
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
