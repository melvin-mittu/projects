...
<tr><th>Appointment Id</th><th>Patient Name</th>
<th>Amount:</th>
<th>Date:</th>
<th>Status</th>
<?php
...
$db=new DatabaseCon;
$q="select * from payment inner join patient on patient.id=payment.vid inner join appointment on appointment.vid=patient.id";
$rs=$db->selectData($q);
