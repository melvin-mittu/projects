						...
						<div class="row ml-0 w-100">
							<div class="col-lg-12 pr-0">
								<ul class="nav navbar-nav center_nav pull-right">
									...
									<li class="nav-item ">
										<a class="nav-link" href="doctorview.php">Doctor</a>
									</li>
									<li class="nav-item ">
										<a class="nav-link" href="labrepview.php">Labreport</a>
									</li>
                                    <li class="nav-item">
												<a class="nav-link" href="preview.php">Prescription</a>
											</li>
...
<tr><th>ADDRESS:</th>
<td><textarea name="t3" rows="10" cols="30"></textarea></td></tr>
<tr><th>GENDER:</th>
<td><input type="radio" name="t4" value="male">MALE
<input type="radio" name="t4" value="female">FEMALE</td></tr>
<tr><th>PHONE NO:</th>
<td><input type="text" name="t5"></td></tr>
<tr><th>EMAIL:</th>
<td><input type="email" name="t6"></td></tr>
<tr><th>experience</th>
<td><input type="text" name="t7"></td></tr>
<tr><th>PASSWORD:</th>
<td><input type="password" name="t8"></td></tr>
