...
<form action="feedbackaction.php" method="GET">
<table align="center" >
<tr><td>NAME:&nbsp;&nbsp;&nbsp;</td>
...
<td><input type="text" name="t8"  required="yes" value="<?php echo $row['name'];?>" class="btn btn-danger" readonly></td></tr>
<?php
}
?>
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>

<tr><th>FEEDBACK:</th><td><textarea name="t9" rows="5" cols="29" class="btn btn-danger"></textarea></td></tr>
<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
...
$q="select * from feedback where vid='$id'";
$rs=$db->selectData($q);
while($row=mysql_fetch_array($rs))
{
	?>
    <tr><td><?php echo $row['name'];?></td>
    <td><?php echo $row['fed'];?></td></tr><?php
}
?>
</table>
</form>
