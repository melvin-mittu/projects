...
$db=new DatabaseCon;
$q="select * from patient inner join appointment on appointment.vid=patient.id inner join prescription on prescription.apid=appointment.apid";
$rs=$db->selectData($q);
while($row=mysql_fetch_array($rs))
{
    ...
    <td><a href="delpatient.php?id=<?php echo $row['id'];?>"><font color="#FF0000">&nbsp;Delete&nbsp;</font></a></td>
    </tr>
    <?php
}
?>
