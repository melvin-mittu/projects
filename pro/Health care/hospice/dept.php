...
<form action="deptaction.php" method="post" enctype="multipart/form-data"  onSubmit="return check();">
<table align="center">

<tr><td>&nbsp&nbsp;&nbsp;</td></tr>
<tr><th>DEPARTMENTS:&nbsp;&nbsp;&nbsp;</th>
<td><select name="t2" required="yes"  >
<option>PAEDIATRION</option>
<option>NEUROLOGY</option>
<option>CARDIOLOGY</option>
<option>GYNOCOLOGY</option>
<option>PSHYCATRI</option>
<option>DENTAL</option>
<option>PHSYCIAN</option>
<option>ORTHO</option>
...
<tr><td colspan="2" align="center"><input type="submit" name="submit" value="ADD" class="btn btn-primary"></td></tr>
</table>
 <br>
    <br>
    <br>
<h1 align="center">DEPARTMENT VIEW</h1>
...
while($row=mysql_fetch_array($rs))
{
	?>
    <tr>
    <td><?php echo $row['deptn'];?></td>
    
    <td><a href="deletedept.php?id=<?php echo $row['deptid'];?>">Delete</a></td>
    </tr>
    <?php
}
?>
