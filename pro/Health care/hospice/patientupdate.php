...
while($row=mysql_fetch_array($rs))
{
    ...
    <tr><td>Name:&nbsp;&nbsp;&nbsp;</td>
    <td><input type="text" name="t1" value="<?php echo $row['name'];?>" class="btn btn-danger" readonly="readonly"></td></tr>
    <tr><td>&nbsp&nbsp;&nbsp;</td></tr>
    <tr><td>Address:&nbsp;&nbsp;&nbsp;</td>
    <td><input type="text" name="t2" value="<?php echo $row['address'];?>" class="btn btn-danger" readonly="readonly"></td></tr>
    <tr><td>&nbsp&nbsp;&nbsp;</td></tr>
     <tr><td>Phone no:&nbsp;&nbsp;&nbsp;</td>
      <td><input type="text" name="t3" maxlength="10" minlength="10" value="<?php echo $row['phno'];?>" class="btn btn-danger"></td></tr>
      <tr><td>&nbsp&nbsp;&nbsp;</td></tr>
      <tr><td>Email:&nbsp;&nbsp;&nbsp;</td>
     <td><input type="email" name="t5" value="<?php echo $row['email'];?>" class="btn btn-danger"></td></tr>
     <tr><td>&nbsp&nbsp;&nbsp;</td></tr>
     <tr><td>Gender:&nbsp;&nbsp;&nbsp;</td>
      <td><input type="text" name="t6" value="<?php echo $row['gender'];?>" class="btn btn-danger" readonly="readonly"></td></tr>
      <tr><td>&nbsp&nbsp;&nbsp;</td></tr>
      <tr><td>Place:&nbsp;&nbsp;&nbsp;</td>
      <td><input type="text" name="t7" value="<?php echo $row['place'];?>" class="btn btn-danger" readonly="readonly"></td></tr>
      tr><td>&nbsp&nbsp;&nbsp;</td></tr>
      <?php
}
?>
